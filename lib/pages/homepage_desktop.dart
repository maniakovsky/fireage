...
class HomePage_desktop extends StatefulWidget {
  const HomePage_desktop({super.key});

  @override
  State<HomePage_desktop> createState() => _HomePage_desktop();
}

// ignore: camel_case_types
class _HomePage_desktop extends State<HomePage_desktop> {
  Timer? timer;
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding:
                    EdgeInsets.only(bottom: height / 5, left: 250, right: 250),
                child: Column(
                  children: [
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                ...
                Wrap(
                  ...
                  children: [
                    ...
                    staffBlock(
                      ...
                      role: 'POMOCNIK',
                      status:
                          playersList.contains('T40xu') ? 'Online' : 'Offline',
                      statusColor: playersList.contains('T40xu')
                          ? ColorsUtils().staffOnline_true
                          : ColorsUtils().staffOnline_false,
                      avatar: 'T40xu',
                      color: ColorsUtils().helper,
